...
public class CartServiceImpl implements CartService {
    ...
    public ServerResponse add(int userId, int count, int productId) {
    ...
    public ServerResponse<CartVO> update(int userId, int count, int productId) {
    ...
    private boolean getAllCheckedStatus(int userId) {
    ...
    public ServerResponse<Integer> getCartProductCount(int userId) {
